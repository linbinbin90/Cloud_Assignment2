...
public class ServletUpload extends HttpServlet {
	...
	private final String LOCAL_PATH = "C:"+File.separator+"temp";
				...
				while (iter.hasNext()) {
					...
					if (item.isFormField()) {
						...
						if (fileName != null && fileName.length() > 0) {
							...
							String filePath = LOCAL_PATH + File.separator + fileName;
							System.out.println(filePath);
							File file = new File(filePath);
							
							//File file = new File(ServletUpload.class.getResource().getFile())
